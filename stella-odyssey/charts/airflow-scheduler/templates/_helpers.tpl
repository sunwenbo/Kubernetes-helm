...
*/}}
{{- define "airflow-scheduler.chart" -}}
...
helm.sh/chart: {{ include "airflow-scheduler.chart" . }}
...
app.kubernetes.io/name: {{ include "airflow-scheduler.name" . }}
...
{{- default (include "airflow-scheduler.fullname" .) .Values.serviceAccount.name }}
{{- else }}
