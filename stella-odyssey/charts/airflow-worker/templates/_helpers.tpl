...
helm.sh/chart: {{ include "airflow-worker.chart" . }}
...
app.kubernetes.io/name: {{ include "airflow-worker.name" . }}
...
{{- default (include "airflow-worker.fullname" .) .Values.serviceAccount.name }}
{{- else }}
