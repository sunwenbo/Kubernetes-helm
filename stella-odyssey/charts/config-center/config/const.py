...
TEMPLATE_NAME_TD = "Teradata ActiveMQ Configurations"
TEMPLATE_NAME_INGEST = "Ingest ActiveMQ Configurations"
TEMPLATE_NAME_SPARK = "Spark ActiveMQ Configurations"

TEMPLATE_NAME = {
    "Teradata Transformation": TEMPLATE_NAME_TD,
    "Sqoop Migrate": TEMPLATE_NAME_INGEST,
    "Spark Transformation": TEMPLATE_NAME_SPARK,
}
